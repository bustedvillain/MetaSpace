...
<title>Recuperar Login | META Space</title>
...
<body>
    ...
    <div id="intro_logo">
        ...
        <div id="intro_general">
        	<h3 class="color_azul">Recuperar Clave</h3>
            <p>Si deseas volver a obtener tu clave de acceso, por favor introduce tu correo electrónico.</p>
            <div id="intro_contacto_form">
           
            <form id="frmContact" class="login" method="POST" action="../../sources/ControladorSesion.php">
