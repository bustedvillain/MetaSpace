...
<title>Generar Reportes Tutor | META Space</title>
    ...
    <p>¿Qué tal los exámenes?</p></div>
              ...
              <div id="tutor_contenido_gris">
                ...
                <div class="contenido">
                	...
                	<ul class="horizontal_btn_largo">
                    
                            
                        <?php generarLINKSReportes($idcursoAbierto)?>
                            
                            
                            
<!--                     <li><a href="#">Evaluaci&oacute;n diagnóstica</a></li>
                         <li><a href="#">Satisfacci&oacute;n y calidad</a></li>
                         <li><a href="#">Evaluaci&oacute;n final</a></li>
                         <li><a href="#">Evaluaci&oacute;n de desempe&ntilde;o</a></li>
                         <li><a href="#">Evaluación de aprovechamiento</a></li>  
                         <li><a href="#">Gestion escolar</a></li>
                         <li><a href="#">Autoevaluaci&oacute;n</a></li>
                         <li><a href="#">Gestion escolar</a></li>
                         <li><a href="#">Autoevaluaci&oacute;n</a></li>-->
                ...
                <div id="tutor_btn">
                    <div id="tutor_btn_regresar"><a href="reportes_cursos.php"> </a></div>
                </div>
             </div>
