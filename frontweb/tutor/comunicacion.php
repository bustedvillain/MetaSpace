...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Comunicación Tutor | META Space</title>
        ...
        <div id="container">
            ...
            <div id="central">
                ...
                <div class="modulo_izq">
                    ...
                    <div id="modulo_mensaje1">
                        <a href="#" onClick="muestra_oculta_letras('contenido_a_mostrar_letras')" title=""></a>
                    </div>

                    <div id="contenido_a_mostrar_letras" class="contenido_a_mostrar_letras" style="display:none;">
                        <!--<a href="#" onClick="muestra_oculta_letras('contenido_a_mostrar_letras')" title=""><div class="extra_general"></div></a>-->
                        <a href="#" onClick="muestra_oculta('contenido_a_mostrar_letras')" title=""><div class="extra_general"></div></a>
                        <span class="tutor_enlace0"><a href="mensaje_tutor.php">Enviar Mensaje a Tutor</a></span>
                        <span class="tutor_enlace1"><a href="mensaje_alumno.php">Enviar Mensaje a Alumno</a></span>
                        <span class="tutor_enlace2"><a href="mensaje_padre.php">Enviar Mensaje al Padre</a></span>
                        <span class="tutor_enlace3"><a href="mensaje_revisar.php">Revisar Mensajes</a></span>
                ...
                <div class="modulo_decha">
                    ...
                    <div id="modulo_mensaje2">
                        <a href="#" onClick="muestra_oculta_mates('contenido_a_mostrar_mates')" title=""></a>
                    </div>
                    <div id="contenido_a_mostrar_mates" class="contenido_a_mostrar_mates" style="display:none;">
                        <a href="#" onClick="muestra_oculta_mates('contenido_a_mostrar_mates')" title=""><div class="extra_general"></div></a>
                        <span class="tutor_enlace1"><a href="mensaje_grupo_alumnos.php">Enviar Mensaje a Alumnos</a></span>
                        <span class="tutor_enlace2"><a href="mensaje_grupo_padres.php">Enviar Mensaje a Padres</a></span>
                ...
                <div class="modulo_izq">
                    ...
                    <div id="contenido_a_mostrar_ciencias" class="contenido_a_mostrar_ciencias" style="display:none;">
                        <a href="#" onClick="muestra_oculta_ciencias('contenido_a_mostrar_ciencias')" title=""><div class="extra_general"></div></a>
                        <span class="tutor_foro_enlace1"><a href="#">Foro por Curso</a></span>
                        <span class="tutor_foro_enlace2"><a href="#">Foro para Padres</a></span>
                        <span class="tutor_foro_enlace3"><a href="#">Foro para Tutores</a></span>
                ...
                <div class="modulo_decha">
                    ...
                    <div id="modulo_enviar">
                        <a href="mensaje_enviar.php" title=""></a>
                    </div>
