...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Mensaje para  grupos de Alumnos | Tutor | META Space</title>
        ...
        <div id="container">
            ...
            <div id="central">
                ...
                <div id="tutor_mensaje">
                    <h2>Mensaje para  grupos</h2>
                    <div class="contenido">

                        <div id="intro_contacto_form">

                            <form id="frmContact" action='enviaMensajeGrupal.php' method ='POST' class="login">
                                <div class="form_tutor">
                                    <div class="msg_check">
                                        <select id="ContactoGrupo" name='idDestinatario'>
                                        <?php @imprimeOptionsDeGruposDeTutor(obtenerIDTabla()); ?>
                                        </select>
                                        <span class="check">
                                            <input id="check_envia" type="checkbox" name='todos' title="Seleccionar todos"/>
                                        </span><span class="check_title">Seleccionar todos</span>
                                    </div>
                                </div>
                                <div class="form_largo_tutor">
                                    ...
                                    <input type="hidden" name='location' value='mensaje_grupo_alumnos.php'/>
                                </div>
