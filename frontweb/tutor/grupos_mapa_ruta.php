...
<title>Grupos Tutor | META Space</title>
...
<body id="tutor">
	...
	<div id="container">
        ...
        <div id="foto_perfil" class="fondo_azul"><img src="../img/tutor/avatar.png" width="77" height="78" class="margin10" /></div>
            </div>
    ...
    <p>¿Qué tal los exámenes?</p></div>
              ...
              <div id="tutor_contenido_gris">
                ...
                <div class="contenido">
                	...
                	<ul class="grupos_list">
                    	<li>Pulse sobre el grupo para desplegarlo.</li>
                    	<li class="gimpar"><a href="mapa.php">5°A - Margarita de Gortari de Salinas - SEP</a></li>
                        <li class="gpar"><a href="mapa.php">5°B - Margarita de Gortari de Salinas - SEP</a></li>
                        <li class="gimpar"><a href="mapa.php">5°C - Margarita de Gortari de Salinas - SEP</a></li>
                        <li class="gpar"><a href="mapa.php">5°D - Margarita de Gortari de Salinas - SEP</a></li>
                        <li class="gimpar"><a href="mapa.php">5°E - Margarita de Gortari de Salinas - SEP</a></li>
                    </ul>
                </div>
                <div id="tutor_btn">
