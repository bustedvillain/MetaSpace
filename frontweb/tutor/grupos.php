              ...
              <div id="tutor_contenido_gris">
                ...
                <div class="contenido">
                	...
                	<ul class="grupos_list">
                        ...
                        <?php 
                        if(isset($_GET['idCursoAbierto'])){
                            generarListadoGrupos($_GET['idCursoAbierto']);
                        }else{
                            generarListadoGrupos();
                        }
                        ?>
<!--                        <li class="gimpar"><a href="grupos_dos.php">SEP - Margarita de Gortari de Salinas - 5°- 32-C</a></li>
                        <li class="gpar"><a href="grupos_dos.php">SEP - Margarita de Gortari de Salinas - 5° - 32-D</a></li>
                        <li class="gimpar"><a href="grupos_dos.php">SEP - Margarita de Gortari de Salinas - 5° - 32-E</a></li>
                        <li class="gimpar"><a href="grupos_dos.php">SEP - Margarita de Gortari de Salinas - 5° - 32-E</a></li>
                        <li class="gimpar"><a href="grupos_dos.php">SEP - Margarita de Gortari de Salinas - 5° - 32-E</a></li>
                        <li class="gimpar"><a href="grupos_dos.php">SEP - Margarita de Gortari de Salinas - 5° - 32-E</a></li>
                        <li class="gimpar"><a href="grupos_dos.php">SEP - Margarita de Gortari de Salinas - 5° - 32-E</a></li>
                ...
                <div id="tutor_btn">
                    <div id="tutor_btn_regresar"><a href="cursos.php"> </a></div>
                </div>
             </div>
