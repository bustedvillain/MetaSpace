...
<title>Ver Reportes Tutor | META Space</title>
...
<div id="container">
    ...
    <p>¿Qué tal los exámenes?</p></div>
           		...
           		<div id="lateral_nav">
            		...
            		<div id="lateral_nav_reportes"><span></span></div>
              ...
              <div id="tutor_contenido_gris">
                ...
                <div class="contenido">
                	...
                	<ul class="grupos_list overf">
                    	<li class="gtitulo">Lista de Grupos </li>
                    	<li class="gimpar"><a href="http://148.208.235.5/softmeta/jr/verReportes.php">SEP - Margarita de Gortari de Salinas - 5° - 32-A</a></li>
                        <li class="gpar"><a href="http://148.208.235.5/softmeta/jr/verReportes.php">SEP - Margarita de Gortari de Salinas - 5°- 32-B</a></li>
                        <li class="gimpar"><a href="http://148.208.235.5/softmeta/jr/verReportes.php">SEP - Margarita de Gortari de Salinas - 5°- 32-C</a></li>
                        <li class="gpar"><a href="http://148.208.235.5/softmeta/jr/verReportes.php">SEP - Margarita de Gortari de Salinas - 5° - 32-D</a></li>
                        <li class="gimpar"><a href="http://148.208.235.5/softmeta/jr/verReportes.php">SEP - Margarita de Gortari de Salinas - 5° - 32-E</a></li>
                    </ul>
                </div>
                <div id="tutor_btn">
