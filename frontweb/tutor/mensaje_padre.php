...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Mensaje para Padre Tutor | META Space</title>
        ...
        <script language="JavaScript">
            ...
            function muestra_combo(idDiv, idCheck) {
                        ...
                        <div id="intro_contacto_form">
                            ...
                            <form action="enviaMensaje.php" method="POST" id="frmContact" class="login">
                                ...
                                <div class="form_tutor">
                                    <select id="MensajeGrupo2" onchange="muestra_combo('div_padre', 'MensajeGrupo')">
                                        <?php echo generarComboGruposTutor(obtenerIDTabla()) ?>
                                    </select>
                                </div>

                                <div id="div_padre" class="form_tutor" >
                                    <select id="ContactoPadre" name="idDestinatario">

                                    </select>
                                </div>

                                <div class="form_largo_tutor">
                                    <textarea required="required" name="mensaje" cols="50" rows="3" wrap="soft" id="LoginMensaje" placeholder="Mensaje..."></textarea>
                                    <input type="hidden" id="location" name="location" value="mensaje_padre.php"/>
                                </div>
