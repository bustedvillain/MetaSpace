...
verificaSesionTutor();
$idTutor = $_SESSION['idPorTabla'];
$arrAmbos = getArrayIdsCursoPorTutor($idTutor);
$arrIdCursos = array_pop($arrAmbos);
$arrIdCursosAb = array_pop($arrAmbos);
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Vista Tutor | META Space</title>
    ...
    <body id="tutor">
        ...
        <div id="container">
            ...
            <div id="central">
                ...
                <div id="lateral_nav">
                    <div id="lateral_nav_cursos"><span></span></div>
                ...
                <?php
                $arrayEventos = imprimeCajasTutor($arrIdCursos, $arrIdCursosAb, $rutaCursos, $cantidad);
                ?>
                <script language="JavaScript">
                    window.onload = function() {/*hace que se cargue la función lo que predetermina que div estará oculto hasta llamar a la función nuevamente*/
                    <?php
...
<!--                <div class="modulo_izq">
                    ...
                    <div id="contenido_a_mostrar_letras" style="display:none;">
                        ...
                        <span class="tutor_enlace1"><a href="grupos.php">Grupos</a></span>
                        <span class="tutor_enlace2"><a href="programa_curso.php">Programa de curso</a></span>
                        <span class="tutor_enlace3"><a href="grupos_mapa_ruta.php">Mapa de ruta</a></span>
