...
<title>Reporte Alumno Tutor | META Space</title>
              ...
              <div id="tutor_contenido_gris">
                ...
                <div class="contenido">
                	...
                	<ul class="grupos_list">
                    	<li class="gtitulo">Manuel Bartual Perón</li>
                    </ul>
                    <h6 class="pregunta">¿Qué desea hacer con el documento?</h6>
                    <ul class="horizontal_btn">
