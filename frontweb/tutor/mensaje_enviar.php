...
<title>Mensaje para enviar |  Tutor | META Space</title>
...
<div class="form_tutor"><input name="nombre" size="35" maxlength="50" type="text" id="ContactoNombre" placeholder="Nombre..."></div>

<div class="form_tutor"><input name="correo" size="35" maxlength="100" type="text" id="ContactoCorreo" placeholder="Correo electrónico..."></div>
