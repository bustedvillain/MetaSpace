...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Mensaje para  grupos de Padres | Tutor | META Space</title>
        ...
        <div id="container">
            ...
            <div id="central">
                ...
                <div id="tutor_mensaje">
                    <h2>Mensaje para  grupos de Padres</h2>
                    <div class="contenido">

                        <div id="intro_contacto_form">

                            <form action='enviaMensajeGrupal.php' method ='POST' id="frmContact" class="login">
                                ...
                                <div class="form_largo_tutor">
                                    ...
                                    <input type="hidden" name='tipo' value='padres'/>
                                    <input type="hidden" name='location' value='mensaje_grupo_padres.php'/>
                                </div>
