              ...
              <div id="tutor_contenido_gris">
                ...
                <div class="contenido">
                	...
                	<ul class="vertical_btn">
                    	...
                    	<li><a href="grupos_lista_alumnos.php?idGrupo=<?php echo $_GET['idGrupo']?>&idCursoAbierto=<?php echo $_GET['idCursoAbierto']?>">Lista de Alumnos Inscritos</a></li>
                        <li><a>Crear y Solicitar tareas</a></li>
                    </ul>
                </div>
                <div id="tutor_btn">
                    <div id="tutor_btn_regresar"><a href="grupos.php?idCursoAbierto=<?php echo $_GET['idCursoAbierto']?>"> </a></div>
                </div>
             </div>
