...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Guardar foto | META Space</title>
                    ...
                    <div id="container">
                        ...
                        <div id="central">
                            ...
                            <div id="alumno_contenido">
                                <h2>Guardar foto</h2>
                                <div class="contenido">
                                    <img src="../img/alumno/locker/foto_ejemplo2.jpg" width="247" height="188" /></div>
                                <div id="btn_guardar">¿guardar?<img src="../img/alumno/guardar_icono.gif" width="60" height="55" /><br /><br />
                                    <a href="javascript:history.back()">NO </a>/ <a href="">SI</a></div>
