                    ...
                    <div id="container">
                        ...
                        <div id="central">
                            ...
                            <div id="alumno_contenido">
                                <h2>Amigos: Comparte con tus compañeros</h2>
                                <div class="contenido">
                                    <ul class="horizontal_btn">
                                        <img src="../img/alumno/amigos.jpg" width="528" height="154" />

                                        <li><a href="mensaje_nuevo.php">Nuevo Mensaje</a></li>
                                        <li><a href="mensaje_revisar.php">Mensajes recibidos</a></li>
