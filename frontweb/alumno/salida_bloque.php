	...
	<div id="container">
        ...
        <div id="foto_perfil" class="fondo_naranja"><img src="<?php echo rutaFotoDeSesion(); ?>" width="77" height="78" class="margin10" /></div>
            ...
            <div id="central">
             ...
             <div id="alumno_bloque">
             	<h2>BLOQUE 2 <img src="../img/alumno/bloque_2_logo.gif" class="elem_absolute" style="top: 0px; right: 80px;" width="57" height="57" /></h2>
                <div class="contenido_largo">
                <div class="elem_left"><img src="../img/alumno/bloque_regalo.jpg" width="674" height="216" /></div>
                ...
                <div id="alumno_bloque_control">
                    ...
                    <div class="elem_absolute" style="top: 45px; left: 280px;"><a href=""><img src="../img/alumno/reintentar.jpg" width="87" height="72" /></a></div>
                    <div class="elem_absolute" style="top: 45px; left: 400px;"><a href=""><img src="../img/alumno/salir.jpg" width="87" height="72" /></a></div>
                </div>
              </div>
