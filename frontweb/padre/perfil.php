...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Perfil Padre | META Space</title>
...
//                    debugConsole('hubo click');
            ...
            function muestraImagenUp() {
//                $("#padre_btn_capturar").click(function() {
                    $("#inputSubida").trigger("click");
//                    debugConsole('hubo click');
//                });
            }
    ...
    <body id="padre">
        ...
        <div id="container">
            ...
            <div id="central">
                ...
                <div id="padre_contenido">
                    <h2>Mi perfil</h2>
                    <?php infoMiperfilPadre(obtenerIDTabla());?>
<!--                    <div class="contenido">
                        <div id="foto_mi_perfil"><img src="../img/padre/foto_mi_perfil.jpg" width="142" height="145" /></div>
                        <div id="datos_padre">
                            Nombre:<br/>
                            <strong>Antonio Molero Sanchéz</strong><br/>
                            Edad: <strong>43</strong><br/>
                            Trabajo: <strong>Ingeniero de sonido</strong><br/><br/>
                            Grupo: <br/>
                            <strong>4-B Pedro</strong><br/>
                            <strong>6-A Ana</strong><br/>
                            <strong>6-B Juan</strong><br/>
                        </div>
                    </div>-->
                    <div id="padre_btn">
                        <div id="padre_btn_regresar"><a href="javascript:history.back()"> </a></div>
                        <div id="padre_btn_capturar"><a  onclick="<?php echo $metodo; ?>"></a></div>
                    </div>
