...
<title>Sinopsis Padre | META Space</title>
  ...
  <div id="container">
        ...
        <div id="foto_perfil" class="fondo_verde"><img src="<?php echo rutaFotoDeSesion(); ?>" width="77" height="78" class="margin10" /></div>
            ...
            <div id="central">
   		  ...
   		  <div id="lateral_nav">
                	<div id="lateral_pad_familia"><a title="" href="index.php"></div>
             ...
             <div id="alumno_sinopsis">
             	<h2>Sinopsis</h2>
                <div class="contenido">
                	<div class="foto_libro_lateral"><img src="../img/alumno/biblioteca/libro_ejemplo.gif" width="141" height="128" class="margin20l margin20t" /></div>
                    
                    <div class="libro_txt"><h1>Sobre el libro</h1> 
