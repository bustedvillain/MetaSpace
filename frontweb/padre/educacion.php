...
<body id="padre">
    ...
    <p>¿Qué tal los exámenes?</p></div>
     ...
     <div class="educacion margin20l">
      <h2>Artículos</h2>
      <ul>
      	<li><a href="articulo.php">EPN y la reforma educativa.</a></li>
        <li><a href="articulo.php">Depresión post-vacacional en niños.</a></li>
        <li><a href="articulo.php">Estudiar y divertirse.</a></li>
        <li><a href="articulo.php">Música para despertar su creatividad.</a></li>
        <li><a href="articulo.php">Niños con problemas de aprendizaje.</a></li>
      </ul>
      </div>
      
      <div class="educacion margin20l margin20t">
      <h2>Videos</h2>
      <img src="../img/padre/video.png" width="140" height="98" class="elem_left margin10 margin40l" />
      <img src="../img/padre/video.png" width="140" height="98" class="elem_left margin10" />
      <img src="../img/padre/video.png" width="140" height="98" class="elem_left margin10" />
      </div>
