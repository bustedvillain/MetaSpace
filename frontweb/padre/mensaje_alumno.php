...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Mensaje para hijo | META Space</title>
        ...
        <div id="container">
            ...
            <div id="central">
                ...
                <div id="tutor_mensaje">
                    <h2 class="color_verde">Enviar mensaje a mi hijo:</h2>
                    <div class="contenido">
                        ...
                        <div id="intro_contacto_form">
                            ...
                            <form  action="enviaMensaje.php" method="POST" id="frmContact" class="login">
                                <div class="form_tutor">
                                    <select id="ContactoAlumno" name='idDestinatario'>
                                        <?php optionsDeHijosDelPadre(obtenerIDTabla()); ?>
                                    </select>
                                </div>
                                <div class="form_largo_tutor">
                                    <textarea name="mensaje" cols="50" rows="3" wrap="soft" id="LoginMensaje" placeholder="Mensaje..." required='required'></textarea>
