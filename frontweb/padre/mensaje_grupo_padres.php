...
<title>Mensaje para  grupos de Padres | Padre | META Space</title>
...
<body id="padre">
    ...
    <p>¿Qué tal los exámenes?</p></div>
              ...
              <div id="tutor_mensaje">
             	<h2 class="color_verde">Mensaje para  grupos de padres</h2>
                <div class="contenido">
                
                <div id="intro_contacto_form">
           
            <form id="frmContact" class="login">
...
<div class="form_tutor">
    ...
    <div class="msg_check">
        ...
        <select id="ContactoGrupo">
        <option value="id del grupo que se obtiene de la consulta en la base de datos" sp>5° A</option>
        <option value="id del grupo que se obtiene de la consulta en la base de datos">5° B</option>
        <option value="id del grupo que se obtiene de la consulta en la base de datos">5° C</option>
        </select>
    
        <span class="check"><input id="check_envia" type="checkbox" title="Seleccionar todos"/></span><span class="check_title">Seleccionar todos</span>
    </div>
</div>
