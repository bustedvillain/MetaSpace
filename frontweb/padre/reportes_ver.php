...
<title>Ver Reportes padre | META Space</title>
...
<body id="padre">
    ...
    <p>¿Qué tal los exámenes?</p></div>
              ...
              <div id="tutor_contenido_gris">
             	<h2>Ver Reportes <small class="elem_right margin50r">Ana María</small></h2>
                <div class="contenido">
                
                	<ul class="vertical_btn_padre">
                    
                    	<li><a href="evaluacion_aprovechamiento.php">Evaluación de aprovechamiento</a></li>
                        <li><a href="evaluacion_desempeno.php">Evaluación de desempeño</a></li>
                        <li><a href="evaluacion_desempeno.php">Gestion escolar</a></li>
                    </ul>
                </div>
                <div id="padre_btn">
