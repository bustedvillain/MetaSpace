...
$idPadre = obtenerIDTabla();
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
        <title>Revisar Mensajes |  Padre | META Space</title>
        ...
        <style>
            ...
            .msgs ul li a:hover{
                background: none repeat scroll 0 0 #02dc02;
                color: #fff;
        ...
        <div id="container">
            ...
            <div id="central">
                ...
                <div id="tutor_mensaje">
                    <h2 class="color_verde">Revisar mensajes</h2>
                    ...
                    <div id="msg_recib" class="contenido_msg_recib">
                        ...
                        <ul class="msgs">
                            ...
                            <?php mensajeAlPadreDeHijos($idPadre, $pagina, $tipo) ?>
<!--                            <li><a href="#"><div class="msg_head"><span class="alignLeft">Antonio Marquez Padre - 5° 32-B</span><span class="alignRight">12/12/12</span></div>
                            ...
                            <?php paginacionTutorDelPadre($idPadre, $tipo) ?>
                        </ul>
