...
<title>Comunicación Padre | META Space</title>
...
<body id="padre">
    ...
    <p>¿Qué tal los exámenes?</p></div>
              ...
              <div id="modulo_p_mensaje1">
                ...
                <a href="#" onClick="muestra_oculta_letras('contenido_a_mostrar_letras')" title=""><div class="extra_padre"></div></a>
                <span class="padre_enlace0"><a href="mensaje_alumno.php">Enviar Mensaje al hijo</a></span>
                <span class="padre_enlace1"><a href="mensaje_tutor.php">Enviar Mensaje al Tutor</a></span>
                <span class="padre_enlace2"><a href="mensaje_revisar.php">Revisar Mensajes</a></span>
              ...
              <div id="modulo_p_mensaje2">
                ...
                <a href="#" onClick="muestra_oculta_mates('contenido_a_mostrar_mates')" title=""><div class="extra_padre"></div></a>
                <span class="padre_enlace1"><a href="">Enviar Mensaje a Alumnos</a></span>
                <span class="padre_enlace2"><a href="">Enviar Mensaje a Padres</a></span>
              ...
              <div id="modulo_p_foros">
                ...
                <a href="#" onClick="muestra_oculta_ciencias('contenido_a_mostrar_ciencias')" title=""><div class="extra_padre"></div></a>
                <span class="padre_foro_enlace1"><a href="#">Foro por Curso</a></span>
                <span class="padre_foro_enlace2"><a href="#">Foro para Padres</a></span>
                <span class="padre_foro_enlace3"><a href="#">Foro para Tutores</a></span>
