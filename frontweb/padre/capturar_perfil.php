...
<title>Capturar Perfil Padre | META Space</title>
...
function muestra_combo(idDiv, idCheck){
	...
	else if (document.getElementById(idCheck).checked != 'none'){
		var el = document.getElementById(idDiv); //Se define la variable "el" igual a nuestro div
...
<body id="padre">
    ...
    <p>¿Qué tal los exámenes?</p></div>
              ...
              <div id="padre_contenido">
             	<h2>Capturar Perfil</h2>
                <div class="contenido_subida">
   	         
             <div class="contenido_subida_enlace"><a href="">Seleccionar imagen desde carpeta >></a></div>
             </div>
                <div id="padre_btn">
