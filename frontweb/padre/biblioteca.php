...
<title>Biblioteca Padre | META Space</title>
        ...
        <div id="foto_perfil" class="fondo_verde"><img src="<?php echo rutaFotoDeSesion(); ?>" width="77" height="78" class="margin10" /></div>
            ...
            <div id="central">
   		  ...
   		  <div id="lateral_nav">
                    ...
                    <div id="lateral_pad_biblioteca"><span></span></div>
       	      </div>
              
             <div id="biblioteca">
             <div id="nav_biblio_padre">
                	<ul>
                    	<li><a href="">Todo</a></li>
   	  ...
   	  <div class="libro_a">
      	<div class="libro_enlace"><a href="sinopsis.php"></a></div>
                    	<div class="libro_sup color_verde">Destacado</div>
                        <div class="libro_a_foto"><img src="../img/alumno/biblioteca/libro_ejemplo.gif" width="141" height="128" /></div>
                        <div class="libro_a_titulo fondo_verde"><h3><a href="sinopsis.php">The House of Loto (Special Edition)...</a></h3></div>
      	...
      	<div class="libro_enlace"><a href="sinopsis.php"></a></div>
                    	<div class="libro_sup color_verde">Destacado</div>
                        <div class="libro_a_foto"><img src="../img/alumno/biblioteca/libro_ejemplo.gif" width="141" height="128" /></div>
                        <div class="libro_a_titulo fondo_verde"><h3><a href="sinopsis.php">Música para niños y padres (2013)...</a></h3></div>
