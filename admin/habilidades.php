    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="hero-unit">
                ...
                <h1>Habilidades</h1>
                <!--<p>Cat&aacute;logo de habilidades relacionado a elementos AER.</p>-->
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="display tabla">
                ...
                <tbody>
                    <?php consultaAtributos("habilidades", "id_habilidad", "nombre_habilidad"); ?>
                </tbody>
            </table>
            ...
            <div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                ...
                <form action="gdaAtributo.php" method="POST">
                    <div class="modal-body">
                        ...
                        <input type="hidden" name="tipoAtributo" value="Habilidad">
                    </div>
