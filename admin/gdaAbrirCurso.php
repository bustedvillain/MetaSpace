        ...
        <body>
            ...
            <div class="container">
                ...
                <div class="hero-unit">
                    ...
                    <img src="../img/ok.png"/>
                    <h3>Para continuar: <a href="enrolarGrupo.php?id=<?=$idCursoAbierto?>" class="btn btn-success">Asignar Grupos</a> &oacute; <a href="cursos.php" class="btn btn-danger">Regresar</a></h3>
