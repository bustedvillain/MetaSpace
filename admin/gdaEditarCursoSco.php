...
//    echo "<br>sets:".$sets["cursos"];
    ...
    if($_FILES["plantillaSco"]["tmp_name"]){
    $url_storage = guardaStorage($_FILES["plantillaSco"]["tmp_name"], $id_curso, "cursos", true);
...
SQL;
       ...
       editaDatos("unidades", $sets, "id_unidad=$id_unidad");
        ...
        if($_POST['launch'][$i]){
            //Query a Moodle
            $sql = "Update mdl_scorm set name='$nombre_unidad', intro='<p>$descripcion</p>' where launch=".$_POST['launch'][$i]."";
            $query->update($sql);
        }
        $i++;
    }
        ...
        <body>
            ...
            <div class="container">
                ...
                <div class="hero-unit">
                    ...
                    <p class="text-right">
                        <a href="cursos.php" class="btn btn-primary">Continuar</a>
                    </p>
