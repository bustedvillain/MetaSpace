    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="hero-unit">
                ...
                <!--<p>Cat&aacute;logo de Grados Escolares.</p>-->
            ...
            <div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                ...
                <form action="gdaGradoEscolar.php" method="POST">
                    <div class="modal-body">
                        <table class="table table-hover table-bordered">
                            <tr>
                                <td>Nivel Educativo:</td>
                                <td>
                                    <select name="id_nivel_escolar" required>
                            ...
                            <tr>
                                <td>Grado Escolar:</td>
                                <td><input type="text" name="grado_escolar" required/></td>
                            </tr>
                        </table>
                        <!--<input type="hidden" name="tipoAtributo" value="Grado_escolar">-->
                    </div>
            ...
            <div id="editarModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                ...
                <form method="POST" action="gdaEditaGradoEscolar.php">
                    <div class="modal-body">                    
                        <table class="table table-hover table-bordered">
                            <tr>
                                <td>Nivel Educativo:</td>
                                <td>
                                    <select name="id_nivel_escolar" id="id_nivel_escolar" required>
                                        <?php comboNivelesEducativos(); ?>
                                    </select>                                    
                                </td>
                            </tr>
