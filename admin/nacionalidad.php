    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="hero-unit">
                ...
                <!--<p>Cat&aacute;logo de Nacionalidades.</p>-->
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="display tabla">
                ...
                <tbody>
                    <?php consultaAtributos("nacionalidad", "id_nacionalidad", "nacionalidad"); ?>
                </tbody>
            </table>
            ...
            <div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                ...
                <form action="gdaAtributo.php" method="POST">
                    <div class="modal-body">
                        ...
                        <input type="hidden" name="tipoAtributo" value="Nacionalidad">
                    </div>
