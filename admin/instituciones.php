    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="hero-unit">
                ...
                <h1>Instituciones</h1>
                <!--<p>Cat&aacute;logo de Instituciones.</p>-->
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="display tabla">
                ...
                <tbody>
                    <?php consultaAtributos("instituciones", "id_institucion", "nombre_institucion"); ?>
                </tbody>
            </table>
            ...
            <div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                ...
                <form action="gdaAtributo.php" method="POST">
                    <div class="modal-body">
                        ...
                        <input type="hidden" name="tipoAtributo" value="Institucion">
                    </div>
