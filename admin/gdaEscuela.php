 ...
 * Script que recibe una escuela y la guarda en la base de datos
 * Esquema del sistema de gestion integral
 */
if ($_POST && !empty($_POST["escuela"])) {
    $idInstitucion=$_POST["idInstitucion"];
    $escuela=  $_POST["escuela"];    
    
    if (insertaEscuela($escuela, $idInstitucion)) {
...
MENSAJE;
        ...
        //Mensaje satisfactorio de insercion
        $mensaje = <<<MENSAJE
        <h3 class='text-error'>En el cat&aacute;logo ya existe la escuela.</h3>
MENSAJE;
    }
