<?php
@require_once('http://200.66.87.58/moodle/config.php');
@require_once('http://200.66.87.58/moodle/course/lib.php');
...
?>
<form autocomplete="off" action="modedit.php" method="post" accept-charset="utf-8" id="mform1" class="mform" onsubmit="try { var myValidator = validate_mod_scorm_mod_form; } catch(e) { return true; } return myValidator(this);">
    <div>
        <div style="display: none;"><input name="scormtype" type="hidden" value="local" />
            <input name="MAX_FILE_SIZE" type="hidden" value="8388608" />
            <input name="mform_showadvanced_last" type="hidden" value="" />
            <input name="updatefreq" type="hidden" value="0" />
            <input name="datadir" type="hidden" value="" />
            <input name="pkgtype" type="hidden" value="" />
            <input name="launch" type="hidden" value="" />
            <input name="redirect" type="hidden" value="no" />
            <input name="redirecturl" type="hidden" value="../mod/scorm/view.php?id=" />
            <input name="course" type="hidden" value="3" />
            <input name="coursemodule" type="hidden" value="" />
            <input name="section" type="hidden" value="1" />
            <input name="module" type="hidden" value="18" />
            <input name="modulename" type="hidden" value="scorm" />
            <input name="instance" type="hidden" value="" />
            <input name="add" type="hidden" value="scorm" />
            <input name="update" type="hidden" value="0" />
            <input name="return" type="hidden" value="0" />
            <input name="sr" type="hidden" value="0" />
            <input name="sesskey" type="hidden" value="<?php echo $USER->sesskey; ?>" />
            <input name="_qf__mod_scorm_mod_form" type="hidden" value="1" />
        </div>
        <table id="form">
            <tr>
                <td>Nombre</td>
            ...
            <tr>
                ...
                <td>
                    <textarea id="intro_editor" name="introeditor[text]" rows="15" cols="80"></textarea>
                    <input name="introeditor[format]" type="hidden" value="1" />
                </td>
            </tr>
            <tr>
                <td>Paquete SCORM</td>
                <td>
                    <div class="filepicker-filename" style="display: block;">
                        <object type='text/html' data='<?php echo $nonjsfilepicker; ?>' height='160' width='600' style='border:1px solid #000'>
                        </object>
                        <input type="hidden" name="packagefile" id="id_packagefile" class="filepickerhidden" value="<?php echo $draftitemid; ?>" />
                    </div>
                </td>
            </tr>
            <tr>
                <td>Habilitar</td>
                <td><input name="timeopen[enabled]" value="1" type="checkbox" /></td>
            </tr>
        </table>
        <input type="submit" value="Guardar" id="id_submitbutton2" />
