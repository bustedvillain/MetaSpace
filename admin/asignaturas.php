...
<?php include("../template/menuAdmin.php"); ?>
        ...
        <div class="container">
            ...
            <div class="hero-unit">
                ...
                <h1>Asignaturas</h1>
                <!--<p>Cat&aacute;logo de asignaturas relacionado a cursos.</p>-->
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="display tabla">
                ...
                <tbody>
                    <?php consultaAtributos("asignaturas", "id_asignatura", "nombre_asignatura"); ?>
                </tbody>
            </table>
            ...
            <div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                ...
                <form action="gdaAtributo.php" method="POST">
                    <div class="modal-body">
                        ...
                        <input type="hidden" name="tipoAtributo" value="Asignatura">
                    </div>
            ...
            <div id="editarModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                ...
                <form action="gdaEditaAtributo.php" method="POST">
                    <div class="modal-body">                    
                        <table class="table table-hover table-bordered">
                            <tr>
                                <td>Asignatura:</td>
