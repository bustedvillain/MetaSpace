...
<?php if (esAdministrador()) { ?>
            ...
            <div class="container">
                ...
                <div class="nav-collapse collapse">
                    <ul class="nav">
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-th-large"></i> Reportes<b class="caret"></b></a>
                            <ul class="dropdown-menu">
                                <li class="dropdown-submenu">
                                    <a href="javascript:void(0)"><i class="icon-upload"></i> Cursos MetaSpace</a>
                                    <ul class="dropdown-menu">
                                ...
                                <li class="dropdown-submenu">
                                    <a href="javascript:void(0)"><i class="icon-upload"></i> Cursos SCORM</a>
                                    <ul class="dropdown-menu">
                                        <li><a href="../admin/reportesScorm.php"><i  class="icon-upload"></i> Generar</a></li>
                                        <li><a href="../admin/verReportesScorm.php"><i  class="icon-search"></i> Listar</a></li>
                                    </ul>
                                </li> 
    ...
    <?php
    include("../senior/verEditarPerfil.php");
