        ...
        <div class="container">
            ...
            <div class="nav-collapse collapse">
                <ul class="nav">
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-book icon-white"></i> Tutores<b class="caret"></b></a>
                        <ul class="dropdown-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="../senior/reportes_1.php"><i  class="icon-user"></i>Subir</a></li>
                            <li><a href="../senior/verReportes.php"><i  class="icon-user"></i>Listar</a></li>
                        </ul>
                    </li>
