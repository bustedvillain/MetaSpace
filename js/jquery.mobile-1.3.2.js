...
(function( $, window ) {
	...
	if ( $.support.orientation ) {
		...
		// developer debugConsole. The actual threshold value is somewhat arbitrary, we just
		// need to make sure it is large enough to exclude the developer debugConsole case.
