    ...
    <body>
        ...
        <div class="container">
            ...
            <ul class="breadcrumb">
                    ...
                    <li><a href="tutoresJrAsignados.php">Tutores Junior</a> <span class="divider">/</span></li>
                    <li><a href="gruposTutorJr.php?idTutor=<?php echo ($_GET['idTutor']);?>">Grupos</a> <span class="divider">/</span></li>
