...
<link href="<?php echo IP_SERVER_PUBLIC.'softmeta/'; ?>frontweb/style/reset.css" type="text/css" rel="stylesheet"  media="all" />
<link href="<?php echo IP_SERVER_PUBLIC.'softmeta/'; ?>frontweb/style/intro.css" type="text/css" rel="stylesheet"  media="all" />
<link href='http://fonts.googleapis.com/css?family=Open+Sans' rel='stylesheet' type='text/css'/>
<link href="http://fonts.googleapis.com/css?family=Dosis:400,300,500" rel="stylesheet" type="text/css"/>

<meta http-equiv="refresh" content="3;url='<?php echo IP_SERVER_PUBLIC.'softmeta/frontweb/login/index.php'; ?> '" />
</head>
...
<!--            <div id="intro_nav_nosotros"><a title="Nosotros" href="nosotros.html"></a></div>
        ...
        <div id="intro_general">
            ...
            <div id="intro_login_form">
                ...
                <h2>La p&aacute;gina que buscas no existe, en breve ser&aacute;s redireccionado al la p&aacute;gina principal</h2>
